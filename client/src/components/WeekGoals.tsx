...
export default function WeekGoals() {
  ...
  return (
    <section className="py-16 md:py-24 px-6 bg-card" data-testid="section-week-goals">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-card-foreground" data-testid="text-goals-title">
